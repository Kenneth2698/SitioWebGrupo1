                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <a href="?controlador=Default&accion=mostrarAgregarAtractivo">
                                    <h5> Agregar atractivo</h5>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <a href="?controlador=Default&accion=mostrarAgregarRuta">
                                    <h5>Crear rutas con distintos atractivos</h5>
                                </a>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <a href="?controlador=Default&accion=mostrarActualizarRuta">
                                    <h5>Actualizar ruta</h5>
                                </a>
